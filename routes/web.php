...
$valid_paths = [
    ...
    "/admin/analytics/pay",
    "/admin/analytics/p2p",
    "/admin/funds-admin/platform-wallets-management",
    "/admin/funds-admin/deposit-tokens",
    "/admin/funds-admin/deposit-tokens/new",
    "/admin/funds-admin/deposit-tokens/{deposit_token_id}/edit",
    ...
    "/admin/sysconfig",
    "/admin/systools/user-groups",
    "/admin/systools/user-groups/{user_group_slug}",
    "/admin/systools/user-groups/{user_group_slug}/edit",
    "/admin/systools/user-groups/new",
    "/admin/systools/user-groups/{user_group_slug}/user-group-memberships",
    "/admin/systools/user-groups/{user_group_slug}/user-group-memberships/new",
