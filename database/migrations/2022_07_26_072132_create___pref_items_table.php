...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('__pref_items')->insert([
            ...
            [
                'key_name' => 'Default Selected Fiat Currency',
                'key_slug' => 'default_fiat_currency_code',
                'value' => 'USD',
                'value_type' => 'enum:fiat_currency_codes',
                'parent_table' => '__users',
                'parent_uid' => 'system',
                'creator_username' => 'system',
            ],
            ...
            [
                'key_name' => 'Platform fee factor on payment transfers',
            ...
            [
                ...
                'key_slug' => 'ankelli_pay_txn_fee_fctr',
                'value' => 0.01,
                'value_type' => 'float',
                'parent_table' => '__users',
                'parent_uid' => 'system',
            ...
            [
                'key_name' => 'Receive Email Notifications',
                'key_slug' => 'receive_notifications',
                'value' => false,
                'value_type' => 'boolean',
                'parent_table' => '__email_addresses',
                'parent_uid' => 'developer.ankelli@gmail.com',
                'creator_username' => 'system',
            ],
            [
                'key_name' => 'Receive Email Notifications',
                ...
                'value_type' => 'boolean',
                'parent_table' => '__email_addresses',
                'parent_uid' => 'sysadmin@ankelli.com',
                'creator_username' => 'system',
            ],
            [
                'key_name' => 'Receive Email Notifications',
                ...
                'value_type' => 'boolean',
                'parent_table' => '__email_addresses',
                'parent_uid' => 'busadmin@ankelli.com',
                'creator_username' => 'system',
            ],
            [
                'key_name' => 'Receive Email Notifications',
