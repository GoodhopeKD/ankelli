...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <link rel="stylesheet" href="{{ env('_HOST_') }}/cdn.emu/bootstrap-5.2.0-dist/css/bootstrap.min.css" >
    <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/fontawesome.min.css" integrity="sha512-P9vJUXK+LyvAzj8otTOKzdfF1F3UYVl13+F8Fof8/2QNb8Twd6Vb+VD52I7+87tex9UXxnzPgWA3rH96RExA7A==" crossorigin="anonymous" referrerpolicy="no-referrer" /> -->
    <!-- <link rel="stylesheet" href="{{ env('_HOST_') }}/cdn.emu/fontawesome-free-5.15.4-web/css/fontawesome.min.css" > -->
    <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/solid.min.css" integrity="sha512-tk4nGrLxft4l30r9ETuejLU0a3d7LwMzj0eXjzc16JQj+5U1IeVoCuGLObRDc3+eQMUcEQY1RIDPGvuA7SNQ2w==" crossorigin="anonymous" referrerpolicy="no-referrer" /> -->
    <!-- <link rel="stylesheet" href="{{ env('_HOST_') }}/cdn.emu/fontawesome-free-5.15.4-web/css/solid.min.css" > -->
    ...
    <!-- <link rel="stylesheet" href="{{ env('_HOST_') }}/cdn.emu/fontawesome-free-5.15.4-web/css/brands.min.css" >  -->
  ...
  <body>
    ...
    <script src="{{ env('_HOST_') }}/cdn.emu/jquery-3.6.0.min.js" ></script>
    <script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/umd/popper.min.js" integrity="sha384-9/reFTGAW83EW2RDu2S0VKaIzap3H66lZH81PoYlFhbGU+6BZp6G7niu735Sk7lN" crossorigin="anonymous"></script>
    <script src="{{ env('_HOST_') }}/cdn.emu/popper-js/1.16.1/popper.min.js" ></script>
    -->
    ...
    <script src="{{ env('_HOST_') }}/cdn.emu/bootstrap-5.2.0-dist/js/bootstrap.bundle.min.js" ></script>
    <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/js/fontawesome.min.js" integrity="sha512-ywaT8M9b+VnJ+jNG14UgRaKg+gf8yVBisU2ce+YJrlWwZa9BaZAE5GK5Yd7CBcP6UXoAnziRQl40/u/qwVZi4Q==" crossorigin="anonymous" referrerpolicy="no-referrer"></script> -->
    <!-- <script src="{{ env('_HOST_') }}/cdn.emu/fontawesome-free-5.15.4-web/js/fontawesome.min.js" ></script> -->
    ...
    <!-- <script src="{{ env('_HOST_') }}/cdn.emu/fontawesome-free-5.15.4-web/js/solid.min.js" ></script> -->
    <script>
      window._ROUTER_BASENAME_ = "{{ env('_ROUTER_BASENAME_') }}"
      window._WEB_URL_ = "{{ env('_WEB_URL_') }}"
      window._API_URL_ = "{{ env('_API_URL_') }}"
    </script>
