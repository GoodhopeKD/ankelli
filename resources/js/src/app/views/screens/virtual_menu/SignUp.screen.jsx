                    ...
                    <div className="modal-body p-5 pt-0">
                        <form className="">
                            ...
                            <div className="form-floating mb-3">
                                ...
                                <label htmlFor="floating_email_address">Email Address</label>
                            </div>
                            <div className="form-floating mb-3">
                            ...
                            <div className="form-floating mb-3">
                                <input type="password" className="form-control rounded-3" id="floating_password_again" placeholder="Password Again" />
                                <label htmlFor="floating_password_again">Password Again</label>
                            </div>
                            <button className="w-100 mb-2 btn btn-lg rounded-3 btn-primary" type="submit" onClick={() => login()}>Sign up</button>
                        </form>
                    </div>
                </div>
            </div>
