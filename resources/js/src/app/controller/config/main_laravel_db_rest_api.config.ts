...
const strictly_auth_clear_endpoints = [
    ...
    'verification_tokens/password_reset',
    'verification_tokens/password_reset/verify_token', // returns user's username
...
const config = {
    ...
    web_url: 'http://localhost/ankelli/public',
    api_url: 'http://localhost/ankelli/public/api',
}
