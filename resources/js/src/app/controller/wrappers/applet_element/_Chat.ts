...
/* Element Imports */
import { __UserDisplayCardResponseObject } from 'app/controller/wrappers/auxilliary/__UserDisplayCardResponseObject'
...
*/
export const _ChatResponseObject = {
    id: undefined as undefined | null | number,
    participant_one_username: undefined as undefined | null | string,
    participant_one: undefined as undefined | null | typeof __UserDisplayCardResponseObject,
    participant_one_visible: undefined as undefined | null | boolean,
    participant_two_username: undefined as undefined | null | string,
    participant_two: undefined as undefined | null | typeof __UserDisplayCardResponseObject,
    participant_two_visible: undefined as undefined | null | boolean,
    last_sent_message: undefined as undefined | null | typeof _MessageResponseObject,
...
*/
export default class _Chat extends _Wrapper_ implements Omit<typeof _ChatResponseObject, casts_t> {
    id: number | null = null
    participant_one_username: string | null = null
    participant_one: typeof __UserDisplayCardResponseObject | null = null
    participant_one_visible: boolean | null = null
    participant_two_username: string | null = null
    participant_two: typeof __UserDisplayCardResponseObject | null = null
    ...
    /* Class Constructor */
    constructor(args: typeof _ChatResponseObject) { super(); this.populate(args) }

    protected populate(args: typeof _ChatResponseObject) {
        this._populate(args)
        this.last_sent_message = args.last_sent_message && typeof args.last_sent_message === typeof _MessageResponseObject ? new _Message(args.last_sent_message) : null
        this.created_datetime = args.created_datetime && typeof args.created_datetime === 'string' ? new _DateTime(args.created_datetime) : null
    }

    /* Creator(s) */

    public static async create(args: typeof _ChatResponseObject) {
    ...
    public async getAddonProp(addon_prop_name: keyof typeof GettableAddonPropsResponseObject, page_select?: laravel_api_page_selection_t, per_page?: number) {
        ...
        if (Object.keys(prop_types).includes(addon_prop_name)) {
            return this._mainLaravelDBAPIGetAddonPropCollection(prop_types[addon_prop_name], { addon_prop_name, addon_prop_parent_table: '__chats', addon_prop_parent_uid: this.id as number }, page_select, per_page)
        } else {
    ...
    public async addAddonProp(prop_name: keyof typeof AddableAddonPropsResponseObject, args: addable_addon_args_t) {
        ...
        args = { ...args, parent_table: '__chats', parent_id: this.id }
