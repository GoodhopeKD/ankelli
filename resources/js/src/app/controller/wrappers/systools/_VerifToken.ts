...
type receiving_resource_table_t = '__email_addresses' | '__phone_nos'
...
export const _VerifTokenRespObj = {
    ...
    receiving_resource_table: undefined as undefined | null | receiving_resource_table_t,
    receiving_resource_id: undefined as undefined | null | number,
    receiving_resource_value: undefined as undefined | null | string,
...
export default class _VerifToken extends _Wrapper_ implements Omit<typeof _VerifTokenRespObj, casts_t> {
    ...
    receiving_resource_table: receiving_resource_table_t | null = null
    receiving_resource_id: number | null = null
    receiving_resource_value: string | null = null
