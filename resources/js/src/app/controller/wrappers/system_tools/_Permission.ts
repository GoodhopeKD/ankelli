...
*/
export const _PermissionResponseObject = {
...
export default class _Permission extends _Wrapper_ implements Omit<typeof _PermissionResponseObject, casts_t> {
    id: number | null = null
    ...
    /* Class Constructor */
    constructor(args: typeof _PermissionResponseObject) { super(); this.populate(args) }

    protected populate(args: typeof _PermissionResponseObject) {
        this._populate(args)
    ...
    public static async create(args: typeof _PermissionResponseObject) {
        return this._mainLaravelDBAPICreate('system_tools/permissions', args)
    }

    /* Readers */

    public static async getOne(params: { id?: number, slug?: string }) {
        return this._mainLaravelDBAPIGetOne('system_tools/permissions/' + (params.slug ? params.slug : params.id))
    }

    public static async getCollection(params: get_collection_params | null = null, page_select?: laravel_api_page_selection_t, per_page?: number) {
        return this._mainLaravelDBAPIGetCollection('system_tools/permissions', params, page_select, per_page)
    }
