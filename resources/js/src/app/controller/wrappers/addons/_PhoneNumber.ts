...
*/
export const _PhoneNumberResponseObject = {
...
*/
export default class _PhoneNumber extends _Wrapper_ implements Omit<typeof _PhoneNumberResponseObject, casts_t> {
    id: number | null = null
    ...
    /* Class Constructor */
    constructor(args: typeof _PhoneNumberResponseObject) { super(); this.populate(args) }

    protected populate(args: typeof _PhoneNumberResponseObject) {
        this._populate(args)
    ...
    public static async create(args: typeof _PhoneNumberResponseObject) {
        return this._mainLaravelDBAPICreate('phone_numbers', args)
    }
    ...
    public async update(args: typeof _PhoneNumberResponseObject) {
        ...
        return this._mainLaravelDBAPIUpdate('phone_numbers/' + this.id, data)
    }
}
