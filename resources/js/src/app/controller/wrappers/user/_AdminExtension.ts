...
type addable_addon_args_t = typeof _PermissionInstanceResponseObject

/* 
	ResponseObject Export
*/
export const _AdminExtensionResponseObject = {
	id: undefined as undefined | null | number,
	user_username:  undefined as undefined | null | string,
	position_title:  undefined as undefined | null | string,
...
*/
export default class _AdminExtension extends _Wrapper_ implements Omit<typeof _AdminExtensionResponseObject, casts_t> {
	id: number | null = null
	user_username: string | null = null
	position_title: string | null = null
	...
	/*
		Class Constructor
	*/
	constructor(args: typeof _AdminExtensionResponseObject) { super(); this.populate(args) }

	protected populate(args: typeof _AdminExtensionResponseObject) {
		this._populate(args)
	...
	public static async create(args: typeof _AdminExtensionResponseObject) {
	...
	public async addAddonProp(prop_name: keyof typeof AddableAddonPropsResponseObject, args: addable_addon_args_t) {
		switch (prop_name) {
			case 'permission_instances':
				...
				} as typeof _PermissionInstanceResponseObject)
